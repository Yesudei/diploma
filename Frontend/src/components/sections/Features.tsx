...
const features = [
  ...
  { 
    ...
    desc: 'Хичээлийн явц, дуусгасан хичээлүүдээ хянах' 
  },
  { 
    icon: '', 
    title: 'Уян хатан цаг', 
  ...
  },
  {
    ...
    desc: 'Түүнийхээ аудио файлыг AI анализ хийж, EQ болон компрессорын зөвлөмж авна',
  },
  {
    icon: '',
    title: 'AI Melody Generation',
    desc: 'MusicVAE загвараар шинэ аяны санаа үүсгэнэ, writer block-аас гарна',
  },
  {
    icon: '',
    title: 'AI Assistant',
    desc: 'Баталгаажсан мэдээлэл дээр суурилсан AI чатбот асуултанд хариулна',
  },
];
