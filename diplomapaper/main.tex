...
\usetikzlibrary{shapes,shapes.geometric,arrows,automata,shadows.blur,shadows}
...
\usepackage[backend=biber,natbib=true,sorting=none,sortcites]{biblatex} % Ном зүйд biber -г ашиглах
...
\thesistitle{Хиймэл оюуны шийдэл бүхий хөгжим боловсруулалтын вэбсайтын дизайн ба хөгжүүлэлт} % Таны ажлын нэр, нүүр болон хураангуй хуудсанд ашигласан. Өөр газарт бол \ttitle командыг хэрэглэнэ
\thesistype{бакалаврын дипломын ажил} % Удирдагчийн нэр, нүүр хуудсанд ашиглана. Дурын газарт бол \thesisname командыг хэрэглэнэ
\supervisor{Дэд профессор Б.Туяацэцэг} % Удирдагчийн нэр, нүүр хуудсанд ашиглана. Дурын газарт бол \supname командыг хэрэглэнэ
\reader{---} % Шүүмжлэгчийн нэр, Дурын газарт бол \readname командыг хэрэглэнэ
\advisor{Доктор(PhD) Ж.Оргил, Магистр(MSc) Э.Батцэцэг} % Зөвлөгчийн нэр, Дурын газарт бол \advicename командыг хэрэглэнэ
...
\addresses{esudei2845@gmail.com} % Таны хаяг, одоогоор ашиглаагүй. Өөр газарт бол \addressname команд��г хэрэглэнэ
\subject{Компьютерийн ухаан} % Таны салбар, одоогоор ашиглаагүй. Дурынр газарт бол \subjectname командыг ашиглана
\keywords{вэб платформ, хөгжим боловсруулалт, RAG, хиймэл оюуны туслах, онлайн сургалт, Next.js, Supabase} % Түлхүүр үгс, одоогоор ашиглаагүй. Дурын газарт бол \keywordnames командыг хэрэглэнэ
...
% MUST-Thesis.cls uses \bffamily in chapter headings; map it to \bfseries.
\let\bffamily\bfseries

% Гарчигт дэд хэсгийн олон түвшний дугаарлалт гаргахгүй, бүлэг ба үндсэн хэсгийн
% дугаарлалтыг л үлдээнэ.
