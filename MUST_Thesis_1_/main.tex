...
extendedchars=false,                     % UTF-8 support
inputencoding=utf8,                      % UTF-8 input encoding
texcl=true,                              % Treat comments as LaTeX
morekeywords={__global__, __device__, function, const, let, var, return, export, default, class, import, from},  % CUDA specific keywords and JavaScript
}

\lstdefinelanguage{JavaScript}{
  keywords={function, const, let, var, return, export, default, class, import, from, null, true, false, if, else, for, while, do, switch, case, break, continue, new, this, try, catch, throw, async, await},
  keywordstyle=\color{blue}\bfseries,
  ndkeywords={define, require, module, exports},
...
\lstdefinelanguage{Dockerfile}{
  keywords={FROM, RUN, CMD, ENTRYPOINT, ENV, COPY, ADD, EXPOSE, WORKDIR, USER, VOLUME, LABEL, MAINTAINER, ONBUILD, STOPSIGNAL, ARG},
  keywordstyle=\color{blue}\bfseries,
  comment=[l]{\#},
  stringstyle=\color{red},
}
...
\renewenvironment{constants}[1]{%
  \chapter*{\constantsname}%
  \addcontentsline{toc}{chapter}{\constantsname}%
  \begin{longtable}{#1}%
}{\end{longtable}}

\renewenvironment{symbols}[1]{%
  \chapter*{\symbolsname}%
...
\thesistitle{AI шийдэл бүхий хөгжим сургалтын вэбсайтын дизайн ба хөгжүүлэлт} % Таны ажлын нэр, нүүр болон хураангуй хуудсанд ашигласан. Өөр газарт бол \ttitle командыг хэрэглэнэ
...
\supervisor{Проф. PhD. Б.Туяацэцэг} % Удирдагчийн нэр, нүүр хуудсанд ашиглана. Дурын газарт бол \supname командыг хэрэглэнэ
\advisor{Доктор(PhD) Ж.Оргил, Магистр Э.Батцэцэг} % Зөвлөгчийн нэр, Дурын газарт бол \advicename командыг хэрэглэнэ
\reader{Шүүгч}
...
\degree{Компьютерийн ухаан} % Боловсролын зэрэг, нүүр болон хураангуй хуудсанд ашигласан. Өөр газарт бол \degreename командыг хэрэглэнэ
\authorshort{Э.Есүдэй} % Таны товч нэр, нүүр болон хураангуй хуудсанд ашигласан. Дурын газарт бол \shortname командыг хэрэглэнэ 
\authorlong{Эрдэнэсүх Есүдэй} % Таны бүтэн нэр, нүүр болон хураангуй хуудсанд ашигласан. Дурын газарт бол \longname командыг хэрэглэнэ 
\addresses{esudei2845@gmail.com} % Таны хаяг, одоогоор ашиглаагүй. Өөр газарт бол \addressname командыг хэрэглэнэ
...
\deptchair{Дэд проф. PhD. А.Хүдэр} % Тэнхим/эрхлэгчийн нэр, нүүр болон хураангуй хуудсанд ашигласан. Дурын газарт бол\chairname командыг хэрэглэнэ
